...
interface AsyncRoseJsonOptions<Data extends Record<string, any>> extends RoseJsonOptions<Data> {
  /**
   * serialize function.
...
class AsyncRoseJson<Data extends Record<string, any>> extends AsyncRoseDB<Data> {
  constructor(public options: AsyncRoseJsonOptions<Data>) {
    super();
  }
...
interface SyncRoseJsonOptions<Data extends Record<string, any>> extends RoseJsonOptions<Data> {
  /**
   * serialize function.
   * @default JSON.stringify
   */
...
class SyncRoseJson<Data extends Record<string, any>> extends SyncRoseDB<Data> {
  constructor(public options: SyncRoseJsonOptions<Data>) {
    super();
  }

...
interface RoseCsonOptions<Data extends Record<string, any>> extends RoseDBOptions<Data> {
  /**
   * json file path.
...
interface AsyncRoseCsonOptions<Data extends Record<string, any>> extends RoseCsonOptions<Data> {
  /**
   * serialize function.
...
class AsyncRoseCson<Data extends Record<string, any>> extends AsyncRoseDB<Data> {
  constructor(public options: AsyncRoseCsonOptions<Data>) {
    super();
  }
...
interface SyncRoseCsonOptions<Data extends Record<string, any>> extends RoseCsonOptions<Data> {
  /**
   * serialize function.
   * @default JSON.stringify
   */
...
class SyncRoseCson<Data extends Record<string, any>> extends SyncRoseDB<Data> {
  constructor(public options: SyncRoseCsonOptions<Data>) {
    super();
  }

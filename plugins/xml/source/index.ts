...
interface RoseXmlOptions<Data extends Record<string, any>> extends RoseDBOptions<Data> {
  /**
   * json file path.
...
interface AsyncRoseXmlOptions<Data extends Record<string, any>> extends RoseXmlOptions<Data> {
  /**
   * serialize function.
...
class AsyncRoseXml<Data extends Record<string, any>> extends AsyncRoseDB<Data> {
  constructor(public options: AsyncRoseXmlOptions<Data>) {
    super();
  }
...
interface SyncRoseXmlOptions<Data extends Record<string, any>> extends RoseXmlOptions<Data> {
  /**
   * serialize function.
   * @default JSON.stringify
   */
...
class SyncRoseXml<Data extends Record<string, any>> extends SyncRoseDB<Data> {
  constructor(public options: SyncRoseXmlOptions<Data>) {
    super();
  }
